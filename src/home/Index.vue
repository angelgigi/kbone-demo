<template>
  <div class="cnt">
    ...
    <div>
      ...
      <button @click="onClickJunpOrder">跳转到订单页</button>
    </div>
    <!-- vue-improve-loader -->
    <div check-reduce>
      <p>这段话不会在小程序里显示</p>
...
import Web from 'reduce-loader!../common/Web.vue' // 导入的是一个组件
import 'reduce-loader!./web' // 导入的是一个字符串
...
export default Vue.extend({
  ...
  created() {
    ...
    if (process.env.isMiniprogram) { // 小程序端
  ...
  methods: {
    ...
    onClickJunpOrder() {
      window.location.href = 'test/order/index'
      // this.$router.push('test/order/index')
    },
  },
})
</script>
